...
// MARK: - Int8
final class Int8ConvertibleFromBlitzValueTests: XCTestCase {
    ...
    private func validate_int8_reverse_convertible(_ int8: Int8, file: StaticString = #file, line: UInt = #line) {
        ...
        guard let reverse_any = Int8.fromBlitzValue(value) else {
...
// MARK: - Int16
final class Int16ConvertibleFromBlitzValueTests: XCTestCase {
    ...
    private func validate_int16_reverse_convertible(_ int16: Int16, file: StaticString = #file, line: UInt = #line) {
        ...
        guard let reverse_any = Int16.fromBlitzValue(value) else {
...
// MARK: - Int32
final class Int32ConvertibleFromBlitzValueTests: XCTestCase {
    ...
    private func validate_int32_reverse_convertible(_ int32: Int32, file: StaticString = #file, line: UInt = #line) {
        ...
        guard let reverse_any = Int32.fromBlitzValue(value) else {
...
// MARK: - Int64
final class Int64ConvertibleFromBlitzValueTests: XCTestCase {
    ...
    private func validate_int64_reverse_convertible(_ int64: Int64, file: StaticString = #file, line: UInt = #line) {
        ...
        guard let reverse_any = Int64.fromBlitzValue(value) else {
...
// MARK: - Int
final class IntConvertibleFromBlitzValueTests: XCTestCase {
    ...
    private func validate_int_reverse_convertible(_ int: Int, file: StaticString = #file, line: UInt = #line) {
        ...
        guard let reverse_any = Int.fromBlitzValue(value) else {
...
// MARK: - UInt
final class UIntConvertibleFromBlitzValueTests: XCTestCase {
    ...
    private func validate_uint_reverse_convertible(_ uint: UInt, file: StaticString = #file, line: UInt = #line) {
        ...
        guard let reverse_any = UInt.fromBlitzValue(value) else {
...
// MARK: - UInt8
final class UInt8ConvertibleFromBlitzValueTests: XCTestCase {
    ...
    private func validate_uint8_reverse_convertible(_ uint8: UInt8, file: StaticString = #file, line: UInt = #line) {
        ...
        guard let reverse_any = UInt8.fromBlitzValue(value) else {
...
// MARK: - UInt16
final class UInt16ConvertibleFromBlitzValueTests: XCTestCase {
    ...
    private func validate_uint16_reverse_convertible(_ uint16: UInt16, file: StaticString = #file, line: UInt = #line) {
        ...
        guard let reverse_any = UInt16.fromBlitzValue(value) else {
...
// MARK: - UInt32
final class UInt32ConvertibleFromBlitzValueTests: XCTestCase {
    ...
    private func validate_uint32_reverse_convertible(_ uint32: UInt32, file: StaticString = #file, line: UInt = #line) {
        ...
        guard let reverse_any = UInt32.fromBlitzValue(value) else {
...
// MARK: - UInt64
final class UInt64ConvertibleFromBlitzValueTests: XCTestCase {
    ...
    private func validate_uint64_reverse_convertible(_ uint64: UInt64, file: StaticString = #file, line: UInt = #line) {
        ...
        guard let reverse_any = UInt64.fromBlitzValue(value) else {
