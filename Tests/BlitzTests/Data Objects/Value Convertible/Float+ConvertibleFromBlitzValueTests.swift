...
// MARK: - Float
final class FloatConvertibleFromBlitzValueTests: XCTestCase {
    ...
    private func validate_float_reverse_convertible(_ float: Float, file: StaticString = #file, line: UInt = #line) {
        ...
        guard let reverse_any = Float.fromBlitzValue(value) else {
...
// MARK: - Double
final class DoubleConvertibleFromBlitzValueTests: XCTestCase {
    ...
    private func validate_double_reverse_convertible(_ double: Double, file: StaticString = #file, line: UInt = #line) {
        ...
        guard let reverse_any = Double.fromBlitzValue(value) else {
