...
extension VM {
    ...
    @discardableResult
    public func defineClass2<T, P0, P1>
    ...
    @discardableResult
    public func defineClass3<T, P0, P1, P2>
    ...
    @discardableResult
    public func defineClass4<T, P0, P1, P2, P3>
    ...
    @discardableResult
    public func defineClass5<T, P0, P1, P2, P3, P4>
    ...
    @discardableResult
    public func defineClass6<T, P0, P1, P2, P3, P4, P5>
    ...
    @discardableResult
    public func defineClass7<T, P0, P1, P2, P3, P4, P5, P6>
    ...
    @discardableResult
    public func defineClass8<T, P0, P1, P2, P3, P4, P5, P6, P7>
    ...
    @discardableResult
    public func defineClass9<T, P0, P1, P2, P3, P4, P5, P6, P7, P8>
    ...
    @discardableResult
    public func defineClass10<T, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9>
